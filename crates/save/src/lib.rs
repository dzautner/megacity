...
use serialization::{
    create_save_data, migrate_save, restore_climate_zone, restore_extended_budget,
...
/// Read-only access to the V2+ resources (policies, weather, unlocks, ext budget, loans, virtual pop, life sim timer, climate zone).
#[derive(SystemParam)]
