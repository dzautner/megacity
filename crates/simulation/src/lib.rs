...
// Modules that need special attributes (cfg-gated, private) are declared manually below.
automod_dir::dir!(pub "src" exclude "plugin_registration", "integration_tests", "test_harness");
